export default class ParentChart {
  ...
  add_margin() {
    ...
    this.getWH(div);
    this.margin = { left:0, right: 20, top:50, bottom: 20 };
  ...
  add_axis() {
    ...
    this.y1 &&
      this.AxisYLeft.transition().delay(200).call(d3.axisLeft(this.y1));
    this.y2 &&
      this.AxisYRight.transition().delay(200).call(d3.axisRight(this.y2));
  }
